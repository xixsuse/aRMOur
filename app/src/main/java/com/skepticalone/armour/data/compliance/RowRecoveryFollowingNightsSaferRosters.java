...
public final class RowRecoveryFollowingNightsSaferRosters extends RowRecoveryFollowingNights {
    ...
    boolean isCompliant(int consecutiveNights, int recoveryDays) {
        if (consecutiveNights < 2) {
            ...
            return recoveryDays >= (isLenient() ? AppConstants.SAFER_ROSTERS_MINIMUM_RECOVERY_DAYS_FOLLOWING_3_NIGHTS_LENIENT : AppConstants.SAFER_ROSTERS_MINIMUM_RECOVERY_DAYS_FOLLOWING_3_NIGHTS_STRICT);
        } else {
