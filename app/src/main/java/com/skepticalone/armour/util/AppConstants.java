...
public final class AppConstants {
    ...
    public static final int
            ...
            CONSECUTIVE_WEEKEND_LENIENT_PERIOD_IN_WEEKS = 2,
            CONSECUTIVE_WEEKEND_STRICT_PERIOD_IN_WEEKS = 3,
            SAFER_ROSTERS_CONSECUTIVE_WEEKEND_LENIENT_PERIOD_IN_WEEKS_STRICT = 6,
            SAFER_ROSTERS_CONSECUTIVE_WEEKEND_LENIENT_PERIOD_IN_WEEKS_LENIENT = 5,
            SAFER_ROSTERS_CONSECUTIVE_WEEKEND_STRICT_PERIOD_IN_WEEKS_STRICT = 9,
            SAFER_ROSTERS_CONSECUTIVE_WEEKEND_STRICT_PERIOD_IN_WEEKS_LENIENT = 8,
