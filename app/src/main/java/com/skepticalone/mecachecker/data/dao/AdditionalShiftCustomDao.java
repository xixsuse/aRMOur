...
@Dao
public abstract class AdditionalShiftCustomDao extends CustomDao<AdditionalShiftEntity> {

    @NonNull
    private final SupportSQLiteStatement insertStatement, setTimesStatement;
    @NonNull
    ...
    AdditionalShiftCustomDao(@NonNull AppDatabase database) {
        super(database);
