...
public class ShiftListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        shifts.add(new Shift(new GregorianCalendar(2016, 1, 3, 7, 30), new GregorianCalendar(2016, 1, 3, 15, 5)));
        shifts.add(new Shift(new GregorianCalendar(2016, 1, 4, 6, 25), new GregorianCalendar(2016, 1, 4, 19, 50)));
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            holder.mShift = mShifts.get(position);
            holder.mIdView.setText("Shift at position " + position);
            holder.mContentView.setText(mShifts.get(position).toString());
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putLong(ShiftDetailFragment.ARG_START, holder.mShift.getStart());
                        arguments.putLong(ShiftDetailFragment.ARG_END, holder.mShift.getEnd());
                        ...
                        intent.putExtra(ShiftDetailFragment.ARG_START, holder.mShift.getStart());
                        intent.putExtra(ShiftDetailFragment.ARG_END, holder.mShift.getEnd());
