...
import com.skepticalone.mecachecker.dialog.AdditionalShiftDatePickerDialogFragment;
import com.skepticalone.mecachecker.dialog.AdditionalShiftTimePickerDialogFragment;
...
public final class AdditionalShiftDetailFragment
    ...
    public void changeDate(long id, @NonNull ShiftData shiftData) {
        showDialogFragment(AdditionalShiftDatePickerDialogFragment.newInstance(id, shiftData));
    }

    @Override
    public void changeTime(long id, boolean isStart, @NonNull ShiftData shiftData) {
        showDialogFragment(AdditionalShiftTimePickerDialogFragment.newInstance(id, isStart, shiftData));
    }
