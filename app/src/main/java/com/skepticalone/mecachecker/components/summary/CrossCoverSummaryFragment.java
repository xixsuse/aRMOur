...
public class CrossCoverSummaryFragment extends SummaryFragment {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new CursorLoader(getActivity(), Provider.crossCoverShiftsUri, PROJECTION, null, null, null);
    }
    ...
    void bindViewHolderToCursor(SummaryViewHolder holder, int row, @NonNull Cursor cursor) {
        switch (row) {
            case 0:
                ...
                break;
            case 1:
                onBindShiftMoney(holder, cursor);
                break;
            default:
    ...
    private void onBindShiftNumber(SummaryViewHolder holder, @NonNull Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            holder.titleView.setText(R.string.cross_cover_shifts);
    ...
    private void onBindShiftMoney(SummaryViewHolder holder, @NonNull Cursor cursor) {
        if (cursor.moveToFirst()) {
