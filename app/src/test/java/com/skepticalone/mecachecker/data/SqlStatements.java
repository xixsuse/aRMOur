...
public class SqlStatements {
    ...
    public void createTable() {
        assertEquals(
                ...
                ShiftContract.RosteredShifts.SQL_CREATE_TABLE
        );
    }
    ...
    public void createTriggerBeforeInsert() {
        assertEquals(
                ...
                ShiftContract.RosteredShifts.SQL_CREATE_TRIGGER_BEFORE_INSERT
        );
    }
    ...
    public void createTriggerBeforeUpdate() {
        assertEquals(
                ...
                ShiftContract.RosteredShifts.SQL_CREATE_TRIGGER_BEFORE_UPDATE
        );
    }
    ...
    public void dropTable() {
        assertEquals(
                ...
                ShiftContract.RosteredShifts.SQL_DROP_TABLE
        );
    }
