...
public class ComplianceConfigTest extends RosteredShiftTest {
    ...
    public void insufficientDurationBetweenShifts() {
        Configuration configuration = NONE_COMPLIANT.withCheckDurationBetweenShifts(true);
    ...
    public void exceedsMaximumDurationOverDay() {
        Configuration configuration = NONE_COMPLIANT.withCheckDurationOverDay(true);
    ...
    public void exceedsMaximumDurationOverWeek() {
        Configuration configuration = NONE_COMPLIANT.withCheckDurationOverWeek(true);
    ...
    public void exceedsMaximumDurationOverFortnight() {
        Configuration configuration = NONE_COMPLIANT.withCheckDurationOverFortnight(true);
    ...
    public void consecutiveWeekendsWorked() {
        ...
        Configuration configuration = NONE_COMPLIANT.withCheckConsecutiveWeekends(true);
        ...
        assertTrue(compliance.getWeekend().compliesWithMaximumWeekendsWorked);
        assertTrue(compliance.isCompliant());
        ...
        assertFalse(compliance.getWeekend().compliesWithMaximumWeekendsWorked);
        assertFalse(compliance.isCompliant());
